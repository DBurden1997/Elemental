...
std::vector< std::vector< std::vector< int > > > MapReader::readMapFile( std::string fileName ) {
...
std::vector< std::vector< int > > MapReader::readMapRow( std::string line ) {
...
std::vector< int > MapReader::readMapTile( std::string tile ) {
